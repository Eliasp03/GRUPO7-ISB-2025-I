...
# Filtrado Wavelet (Symlet 4)
wavelet = 'sym4'
niveles = 3          # Segun literatura
...
plt.plot(tiempo, ecg_filtrada, label='ECG filtrada (sym4)', color='black', alpha=0.8)
plt.title("Filtrado de señal ECG con Wavelet Symlet 4 - Ejercicio")
plt.xlabel("Tiempo (s)")
...
plt.xlim(5, 15)
plt.tight_layout()
plt.savefig("wavelet_ecg_ejer1der_lvl3.png")  # Guardar imagen
plt.show()