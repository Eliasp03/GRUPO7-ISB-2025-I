# Laboratorio 14 - Avance Final del Proyecto

## MyoTrackML: Análisis de señales EMG para detección de patrones de fatiga muscular en miembro inferior
...
### Avance actual:
- Se cambió el nombre del aplicativo acorde recomendación del docente con el objetivo de su posterior envío para registro.
- Se realizó el paper científico en formato IEEE.
- Se realizó el poster para su posterior exposición a la espera de confirmación.
- Se realizó los documentos adjuntados en https://drive.google.com/drive/folders/1ZEoO9-hdSOvwrvsX-3-JV0oUayTpfYks?usp=sharing
...
![](L14_images/machine1.png)
![](L14_images/machine2.png)
...
![](L14_images/clasificacion.png)
![](L14_images/matriz.png)
![](L14_images/importancia.png)
